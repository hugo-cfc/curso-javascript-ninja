(function() {  
  ...
  */  
  let hugo = new Person('Hugo', 'Cesar', 21)
  let joao = new Person('João', 'Carlos', 43)
  let junior = new Person('Júnior', 'Silva', 34)
  ...
  */
  ...
  /*Hugo Cesar tem 21 anos.
  João Carlos tem 43 anos.
  Júnior Silva tem 34 anos.*/
