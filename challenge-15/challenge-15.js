(function () {
  ...
  */
  ...
  let joao = new Person("João", "Pedro", 21);
  let maria = new Person("Maria", "José", 73);
  let jose = new Person("José", "Maria", 64);
  ...
  */
  ...
  console.log(
    `${jose.getFullName()} agora tem ${jose.addAge(2).getAge()} anos.`
  );
})();
