(function (win, doc) {
  ...
  */
  ...
  let hugo = new Person("Hugo", "Cesar");
  let joao = new Person("João", "Costa");
  ...
  */
  ...
  console.log(getFullName2.apply(tereza));
  console.log(getFullName2.call(maria));
  ...
  */
  ...
  let regexNan = /\d+/g;
  function justNumbers(removeNan) {
    return removeNan.match(regexNan);
  }
