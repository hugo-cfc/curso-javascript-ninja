...
function showTeamPosition(position) {
    ...
    return  position > 5 ? `Não temos a informação do time que está nessa posição.` : `O time que está em ${position}º é o ${teams[position - 1]}`
}
...
*/
console.log(showTeamPosition(1)) //O time que está em 1º é o CRB
console.log(showTeamPosition(2)) //O time que está em 2º é o csa
console.log(showTeamPosition(3)) //O time que está em 3º é o ASA
