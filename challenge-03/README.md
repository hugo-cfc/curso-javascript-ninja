...
pessoa.apresentacao = function() {
    ...
    return `Olá, ${souoa} ${pessoa.nomeCompletoBruto()}, tenho ${pessoa.idade} ${anos}, ${pessoa.altura} metros, meu peso é ${pessoa.peso} e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros} ${metros}!`
