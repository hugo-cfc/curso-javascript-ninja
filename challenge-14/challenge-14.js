(function () {
  ...
  */
  ...
  let justMod2Or3 = justNumbers.filter(function (item, index) {
  ...
  */
  ...
  let name = ["Hu", "go"];
  console.log("p" + name.join("p"));

  let name2 = ["Fer", "nan", "do"];
  console.log("p" + name2.join("p"));

  console.log(
    name2.reduce(function (accumulated, current) {
