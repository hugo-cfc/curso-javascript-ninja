(function () {
    ...
    */
    ...
    let justNumbersRegex = new RegExp('^(\\d+)', 'gmi')
    ...
    */
    ...
    function hasClass(markup, cssClass) {
        let regex = new RegExp('<\\w+ class=[\'"]'+cssClass+'[\'"]>', 'gmi')
    ...
    arrayTest.map(function(item) {
        console.log('Com map: ' + hasClass(markup, item))
    })

    for(let prop in arrayTest) {
